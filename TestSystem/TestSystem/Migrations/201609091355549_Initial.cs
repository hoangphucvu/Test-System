    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Result_Id, t.Users_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ResultUsers", "Users_Id", "dbo.Users");
            DropForeignKey("dbo.ResultUsers", "Result_Id", "dbo.Results");
            ...
            DropIndex("dbo.ResultUsers", new[] { "Users_Id" });
            DropIndex("dbo.ResultUsers", new[] { "Result_Id" });
